...
class UMAPexplorer():
    ...
    def calculateGeneCorrelations(self, indices):
        ...
        self.renderer.scrollList.setList(sortedGenes)
    ...
    def calculateGeneMinMax(self, indices, selGene):
        ...
        print("Min/max expression level for gene", self.geneNames[selGene], minGeneExp, maxGeneExp)
        self.renderer.minGeneExp = minGeneExp
        self.renderer.maxGeneExp = maxGeneExp
